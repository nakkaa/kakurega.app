...
export interface Locale extends ILocale {
     ...
     * リアクションの受け入れを記憶する
     */
    "rememberReactionAcceptance": string;
    /**
     * 添付取り消し
     */
    "attachCancel": string;
    ...
    "ageCheck": string;
    /**
     * トラブル防止のため、このサーバーは{age}歳未満の方はご利用頂けません。
     */
    "ageCheckDescription": ParameterizedString<"age">;
    /**
     * 私は{age}歳以上です
     */
    "ageCheckYes": ParameterizedString<"age">;
    /**
     * ファイルを添付
     */
    "attachFile": string;
    ...
    /**
     * 受信ソースが「全てのノート」かつ受信キーワードが指定されていないアンテナは作成できません
     */
    "antennaNoKeywordsError": string;
    /**
     * ユーザーが指定されていないアンテナは作成できません
     */
    "antennaNoUsersError": string;
    /**
     * 除外キーワード
     */
     ...
     * ご支援者のみなさま (順不同、敬称略)
     */
    "supporterListTitle": string;
    /**
     * {name}は以下のみなさまにご支援を頂いております。
     */
    "supporterDescription": ParameterizedString<"name">;
    /**
     * 他にも多くの方からご支援を頂いております。本当にありがとうございます！
     */
    "moreSupporters": string;
    /**
     * 支援者ロール
     */
    "supporterRoles": string;
    /**
     * 支援者ページで表示したいロールのIDを改行で区切って記述します。ここで記述されたロールに含まれるユーザーが支援者ページで表示されます。
     */
    "supporterRolesDescription": string;
    /**
     * 支援者名を表示するしきい値
     */
    "supporterNameThreshold": string;
    /**
     * ここで入力された値より多く寄付されている方の名前が支援者ページに表示されます。
     */
    "supporterNameThresholdDescription": string;
    /**
     * 支援者名(アイコン付き)を表示するしきい値
     */
    "supporterNameWithIconThreshold": string;
    /**
     * ここで入力された値より多く寄付されている方の名前とアイコンが支援者ページに表示されます。
     */
    "supporterNameWithIconThresholdDescription": string;
    /**
     * ユーザー名を改行で区切って指定します
     */
    ...
    /**
     * ノートが投稿されていないチャンネルを除外
     */
    "excludeNonActiveChannels": string;
    /**
     * チャンネルの説明文も検索対象にする
     */
    ...
    "branding": string;
    /**
     * 支援者ページに自分の名前を記載しないようにする
     */
    "hideFromSupporterPage": string;
    /**
     * 反映まで最大1時間程度かかる場合があります。
     */
    ...
    /**
     * {instance}では、不具合の原因の特定を行えるよう、問題が発生したときにエラーの詳細情報を取得しています。ONにすることで、エラー情報の送信をしないようにします。
     */
    "optoutStatisticsDescription": ParameterizedString<"instance">;
    /**
     * フォローリクエストを自動で拒否する
     */
    ...
    /**
     * 有効にすると、指定した期間内に指定した数以上のアカウントを作成できないようにします。招待コードを持っているユーザーは制限に関係なくアカウントを作成できます。
     */
    "enableRegistrationLimitDescription": string;
    /**
     * 現在、新規アカウントの登録制限が有効になっています。招待コードをお持ちでない場合はアカウント登録が行えない可能性があります。
     */
    "registrationLimitEnabled": string;
    /**
     * このサーバーでは{limit}時間以内に最大{count}人までご登録いただけます。招待コードをお持ちの場合は制限に関係なくアカウント登録を行えます。
     */
    "registrationLimitDetails": ParameterizedString<"limit" | "count">;
    /**
     * アカウント登録制限の期間
     */
    "registrationLimitCooldown": string;
    /**
     * アカウント作成数のカウント対象となる期間を指定できます。この期間内にN個のアカウントを作成することができます。
     */
    ...
    /**
     * 「アカウント登録制限の期間」で指定した期間内に作成できる最大アカウント数です。
     */
    ...
    /**
     * 現在、{time}時間以内に登録できるアカウント数の上限に達しているため、新たにアカウントを作成することができません。時間を置いて再度お試しください。
     */
    "hitRegistrationLimit": ParameterizedString<"time">;
    /**
     * アイコンデコレーション
     */
    ...
    "doReaction": string;
    /**
     * 「みつける」のローカルユーザーを無効にする
     */
    "disableExploreLocalUsers": string;
    /**
     * 「みつける」のユーザータブ内にあるローカルユーザーの表示を無効にします。ピン留めユーザーは無効になりません。
     */
    ...
    /**
     * 非ログイン時のトップページ右側に表示されるハイライトタイムラインを無効にします。
     */
    ...
    /**
     * ここで入力した年齢が年齢制限のしきい値として登録時の確認フォームに表示されます。
     */
    ...
    "showWidgets": string;
    /**
     * あなたのPixivユーザーID (数字のみ) またはPixivのプロフィールのURLを貼り付けてください
     */
    "enterPixivIdOrUrl": string;
    /**
     * 入力された文字列からユーザーIDを取得することが出来ませんでした。貼り付けた内容をご確認の上、もう一度お試しください。
     */
    "invalidPixivId": string;
    /**
     * このPixivユーザーIDは既に連携されているため、このアカウントに連携することが出来ませんでした。以前に連携した覚えがない場合は、お手数をお掛けしますが管理人にお問い合わせください。
     */
    "failedToSetPixivId": string;
    /**
     * 連携に成功しました！ (反映されるまで時間がかかる場合があります)
     */
    ...
    "_role": {
        ...
        "_condition": {
            ...
            /**
             * Patreon/FANBOXの支援額が～円(セント)以下
             */
            "patreonAmountsLessThanOrEq": string;
            /**
             * Patreon/FANBOXの支援額が～円(セント)以上
             */
            "patreonAmountsMoreThanOrEq": string;
            /**
             * 投稿数が～以下
             */
    ...
    "_collapseRenotesTrigger": {
        /**
         * Renoteやリアクションをしたことがある場合 (デフォルト)
         */
        "action": string;
        /**
         * 一度でもRenoteを見たことがある場合
         */
        "see": string;
        /**
         * すべてのRenoteを省略する
    ...
    "_sortType": {
         ...
         * 投稿数が少ない順
         */
        "notesCountAsc": string;
        /**
         * 参加人数が多い順
         */
        "usersCountDesc": string;
        /**
         * 参加人数が少ない順
         */
        "usersCountAsc": string;
        /**
         * 更新日時が新しい順
         */
        "lastNotedAtDesc": string;
        /**
         * 更新日時が古い順
         */
        "lastNotedAtAsc": string;
        /**
         * 名前 (降順)
         */
        "nameDesc": string;
    ...
    "_instanceMuteGtl": {
        /**
         * グローバルタイムラインでのみ有効なサーバーミュートです。
         */
        "instanceMuteDescription": string;
        /**
         * ミュートするサーバー (グローバルタイムライン)
         */
        "heading": string;
    };
    "_theme": {
    ...
    "_notification": {
         ...
         * {name}がノートしました
         */
        "newNote": ParameterizedString<"name">;
        /**
         * アンテナ {name}
         */
