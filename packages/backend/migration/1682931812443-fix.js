export class Fix1682931812443 {
    name = 'Fix1682931812443'
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "antenna" ALTER COLUMN "lastUsedAt" SET DEFAULT '2023-04-04 15:56:35.329414+09'`);
