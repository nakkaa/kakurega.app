...
export class RoleService implements OnApplicationShutdown, OnModuleInit {
	...
	@bindThis
	public async getUserPolicies(userId: MiUser['id'] | null, overridePolicies?: Partial<RolePolicies>): Promise<RolePolicies> {
