...
import { MiNoteNotification } from '@/models/NoteNotification.js';
...
export type NoteNotificationsRepository = Repository<MiNoteNotification> & MiRepository<MiNoteNotification>;
