...
// @public (undocumented)
type IntegrationsFanboxConnectRequest = operations['integrations___fanbox___connect']['requestBody']['content']['application/json'];

// @public (undocumented)
type IntegrationsFanboxConnectResponse = operations['integrations___fanbox___connect']['responses']['200']['content']['application/json'];
