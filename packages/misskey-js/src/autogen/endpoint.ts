...
export const endpointReqTypes: Record<keyof Endpoints, 'application/json' | 'multipart/form-data'> = {
	...
	'channels/list': 'application/json',
	...
	'integrations/fanbox/connect': 'application/json',
	'integrations/fanbox/disconnect': 'application/json',
	'integrations/fanbox/request-refresh': 'application/json',
	'integrations/patreon/request-refresh': 'application/json',
	...
	'note-notification/create': 'application/json',
	'note-notification/delete': 'application/json',
	'note-notification/list': 'application/json',
	...
	'signup-available': 'application/json',
	'stats': 'application/json',
	'supporter-list': 'application/json',
