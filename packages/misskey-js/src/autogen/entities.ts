...
export type IntegrationsFanboxConnectRequest = operations['integrations___fanbox___connect']['requestBody']['content']['application/json'];
export type IntegrationsFanboxConnectResponse = operations['integrations___fanbox___connect']['responses']['200']['content']['application/json'];
...
export type NoteNotificationCreateRequest = operations['note-notification___create']['requestBody']['content']['application/json'];
export type NoteNotificationDeleteRequest = operations['note-notification___delete']['requestBody']['content']['application/json'];
export type NoteNotificationListRequest = operations['note-notification___list']['requestBody']['content']['application/json'];
export type NoteNotificationListResponse = operations['note-notification___list']['responses']['200']['content']['application/json'];
...
export type SignupAvailableResponse = operations['signup-available']['responses']['200']['content']['application/json'];
export type StatsResponse = operations['stats']['responses']['200']['content']['application/json'];
export type SupporterListResponse = operations['supporter-list']['responses']['200']['content']['application/json'];
