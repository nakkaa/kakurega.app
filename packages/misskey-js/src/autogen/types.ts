...
export type paths = {
  ...
  '/integrations/fanbox/connect': {
     ...
     */
    post: operations['integrations___fanbox___connect'];
  };
  '/integrations/fanbox/disconnect': {
     ...
     * **Credential required**: *Yes* / **Permission**: *write:integrations*
     */
    post: operations['integrations___fanbox___disconnect'];
  };
  '/integrations/fanbox/request-refresh': {
     ...
     */
    post: operations['integrations___fanbox___request-refresh'];
  };
  '/integrations/patreon/request-refresh': {
     ...
     * **Credential required**: *Yes* / **Permission**: *read:integrations*
     */
    post: operations['integrations___patreon___request-refresh'];
  };
  '/invite/create': {
    /**
     * invite/create
  ...
  '/signup-available': {
     ...
     * **Credential required**: *No*
     */
    post: operations['signup-available'];
  };
  '/stats': {
    /**
     * stats
  ...
  '/supporter-list': {
     ...
     * **Credential required**: *No*
     */
    post: operations['supporter-list'];
  };
...
export type components = {
  schemas: {
    ...
    MeDetailedOnly: {
      ...
      integrations: Record<string, never> | null;
...
export type operations = {
      ...
      200: {
        content: {
          'application/json': {
            ...
            patreonClientSecret?: string | null;
            patreonAccessToken?: string | null;
            patreonRefreshToken?: string | null;
            fanboxApiBackendUrl?: string | null;
            ...
            supporterNameThreshold?: number | null;
            supporterNameWithIconThreshold?: number | null;
    ...
    requestBody: {
      content: {
        'application/json': {
          ...
          enableRegistrationLimit?: boolean | null;
          registrationLimit?: number | null;
          registrationLimitCooldown?: number | null;
    ...
    requestBody: {
      content: {
        'application/json': {
          ...
          offset?: number;
          search?: string | null;
          excludeNonActiveChannels?: boolean | null;
          includeDescription?: boolean | null;
          /** @enum {string|null} */
          sort?: '+lastNotedAt' | '-lastNotedAt' | '+name' | '-name' | '+notesCount' | '-notesCount' | '+usersCount' | '-usersCount';
        };
      };
    };
    responses: {
   ...
   * **Credential required**: *Yes* / **Permission**: *write:integrations*
   */
  integrations___fanbox___connect: {
    requestBody: {
      content: {
        'application/json': {
          id: string;
   ...
   * **Credential required**: *Yes* / **Permission**: *write:integrations*
   */
  integrations___fanbox___disconnect: {
    responses: {
      /** @description OK (without any results) */
      204: {
        content: never;
   ...
   * **Credential required**: *Yes* / **Permission**: *read:integrations*
   */
  'integrations___fanbox___request-refresh': {
    responses: {
      /** @description OK (without any results) */
      204: {
        content: never;
   ...
   * **Credential required**: *Yes* / **Permission**: *read:integrations*
   */
  'integrations___patreon___request-refresh': {
    responses: {
      /** @description OK (without any results) */
      204: {
        content: never;
